    ...
    <>
      <section className={styles.gridContainer}>
        ...
        <div className={styles.section}>
          <h2 className={styles.sectionTitle}>Introduction to Dental Professional Education</h2>
      ...
      <section className={styles.gridContainer}>
        <div className={styles.section}>
          <h2 className={styles.sectionTitle}>Educational Pathways</h2>
          <h3 className={styles.sectionTitle}>Dental School</h3>
          ...
          <h3 className={styles.sectionTitle}>Specialty Training</h3>
          <ul className={styles.ulList}>
          ...
          <h3 className={styles.sectionTitle}>Dental Hygiene and Assisting</h3>
          <ul className={styles.ulList}>
      ...
      <section className={styles.gridContainer}>
        ...
        <div className={styles.section}>
          <h2 className={styles.sectionTitle}>Key Competencies for Dental Professionals</h2>
          <ul className={styles.ulList}>
      ...
      <section className={styles.gridContainer}>
        <div className={styles.section}>
          <h2 className={styles.sectionTitle}>Licensure and Continuing Education</h2>
          <h3 className={styles.sectionTitle}>Licensure</h3>
          <ul className={styles.ulList}>
          ...
          <h3 className={styles.sectionTitle}>Continuing Education (CE)</h3>
          <ul className={styles.ulList}>
      ...
      <section className={styles.gridContainer}>
        ...
        <div className={styles.section}>
          <h2 className={styles.sectionTitle}>Professional Development and Specialization</h2>
          <ul className={styles.ulList}>
